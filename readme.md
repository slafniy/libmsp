[![last master build](https://github.com/slafniy/libmsp/actions/workflows/build_release.yml/badge.svg?branch=master&v=1)](https://github.com/slafniy/libmsp/actions/workflows/build_release.yml)
